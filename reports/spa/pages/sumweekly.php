...
<table id="myTable" data-toggle="table" data-url="./controllers/json_sum_weekly.php" data-pagination="true" data-page-size="25" data-click-to-select="true" data-page-list="[10, 25, 50, 100, ALL]" data-toolbar="#toolbar" data-show-export="true" data-show-refresh="true" data-show-columns="true">
    <thead>
        <tr>
            <th colspan="7" data-align="left"><strong>Savan Legend Resorts sole Company Limited.</strong></th>
        </tr>
        <tr></tr>
        <th colspan="7" data-align="left"><strong>Summary Weekly Report</strong></th>
        </tr>
        <tr>
