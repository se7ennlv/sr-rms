...
<table id="myTable"
       data-toggle="table"
       data-url="./controllers/json_hr_raw_data.php?fromDate=<?= $fromDate; ?>&toDate=<?= $toDate; ?>&orgCode=<?= $orgCode; ?>"
    ...
    <thead>
        ...
        <tr>
            ...
            <th data-field="Date" data-sortable="true" class="text-nowrap">Date</th>
            <th data-field="Time" data-sortable="true" class="text-nowrap">Time</th>
        </tr>
    </thead>
</table>
