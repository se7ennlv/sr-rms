...
<table id="myTable"
       data-toggle="table"
       data-url="./controllers/json_fail_data.php?fromDate=<?= $fromDate; ?>&toDate=<?= $toDate; ?>&orgCode=<?= $orgCode; ?>"
    ...
    <thead>
        ...
        <tr>
            <th colspan="16" data-align="left"><strong>[Fail Data] Period [<strong><?= $fromDate; ?> - <?= $toDate; ?></strong>]</strong></th>
        </tr>
        <tr>
