...
<table id="myTable"
       data-toggle="table"
       data-url="./controllers/json_count_by_period_data.php?fromDate=<?= $fromDate; ?>&toDate=<?= $toDate; ?>&station=<?= $station; ?>"
    ...
    <thead>
        ...
        <tr>
            <th colspan="7" data-align="left"><strong><?= $station; ?> (Count Person by Periods)</strong></th>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <th data-field="Total" data-sortable="true" class="text-center">Totals</th>
        </tr>
    </thead>
</table>
...
<script type="text/javascript">
    function getCurDate() {
        ...
        return 'count_person_by_periods_report_' + today;
    }
