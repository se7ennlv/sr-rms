! function(a) {
    a.fn.smkValidate = function() {
        ...
        for (var b = a.split("@"), c = b[0].charAt(0), d = b[0].slice(-1), e = "", f = 0; f < b[0].length - 2; f++) e += "*";
        var g = c + e + d + "@" + b[1];
        return g
        ...
        } else "end" == c.status && a(c.element + " .smk-progressbar .progress .progress-bar").width("110%").delay(200, function() {
